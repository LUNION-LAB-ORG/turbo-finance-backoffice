...
const groupCommissionByMonth = (commission: ICommission[]) => {
...
export function CommissionMensuelleChart({ commission = [] }: CommissionMensuelleProps) {
    // Transformer les données des commissions en format pour le graphique
    const chartData = useMemo(() => {
        return groupCommissionByMonth(commission)
    }, [commission])

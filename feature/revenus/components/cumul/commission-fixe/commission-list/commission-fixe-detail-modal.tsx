...
export function CommissionFixeDetailModal({ commissionFixee }: CommissionFixeDetailModalProps) {
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 ">
                        ...
                        />
                        Détails de la commission fixe <span className="font-bold text-red-500">REF-{commissionFixee.commandeId}</span>
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="reference"
                            defaultValue={"REF-" + commissionFixee.commandeId}
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="livreur"
                            defaultValue={commissionFixee.nomRestaurant}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="coutCommande"
                            defaultValue={`${commissionFixee.localisation}`}
                            className="col-span-3"
                            readOnly
                        />
                    </div>

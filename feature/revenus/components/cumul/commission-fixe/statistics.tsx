...
export default function Statistics({ commissionFixe = [] }: StatisticsProps) {
    ...
    const totalCommissionJour = commissionFixe.reduce((total, commissionvariable) => {
    ...
    const totalCommissionSemaine =  commissionFixe.reduce((total, commissionvariable) => {
    ...
    const totalCommissionMois = commissionFixe.reduce((total, commissionvariable) => {
    ...
    const totalCommissionAnnee = commissionFixe.reduce((total, commissionvariable) => {

...
export default function LastCommissionFixe() {
            ...
            <Card className="max-w-6xl mx-auto shadow-lg rounded-xl overflow-hidden border-0">
                ...
                <CardContent className="p-0">
                    <div className="flex flex-col gap-5 p-5">
                        {commissionFixe.map((commissionFixe, index) => (
                            <div key={index} className="rounded-lg shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-all duration-300">
                                <div className="p-5">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <h3 className="font-semibold text-lg text-red-500">{commissionFixe.restaurant}</h3>
                                        </div>
                                        <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                                            {commissionFixe.statut}
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex justify-around items-start gap-3 mt-2">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-sm font-medium">{commissionFixe.date}</span>
                                        </div>
                                     
                                        <div className="flex flex-col col-span-2">
                                            <span className="text-sm text-gray-500">Montant</span>
                                            <span className="text-sm font-bold text-indigo-700">{commissionFixe.montant} FCFA</span>
                                        </div>
                                    </div>
                                </div>

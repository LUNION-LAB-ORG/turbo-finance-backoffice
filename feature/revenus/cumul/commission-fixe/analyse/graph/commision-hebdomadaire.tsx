...
export const description = "Commission(fixe) hebdomadaire"
...
const chartConfig = {
    commission: {
        label: "Commission(fixe) hebdomadaire",
        color: "hsl(142, 75.20%, 44.30%)", 
    },
} satisfies ChartConfig

export function CommissionHebdomadaireChart() {
    return (
            <div>
                <div  className="pt-0">
                    ...
                    <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                        <span>Commission(fixe) hebdomadaire(millions)</span>
                        <span>Semaine</span>
                    </div>
                </div>
            </div>

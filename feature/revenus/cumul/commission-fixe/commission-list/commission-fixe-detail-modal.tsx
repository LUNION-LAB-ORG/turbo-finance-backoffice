...
import { Eye, Calendar, User, DollarSign, Percent, Hash, MapPin, Home } from "lucide-react";
import { CommissionFixe } from "@/feature/revenus/types/revenus.types";
import Image from "next/image";
interface CommissionFixeDetailModalProps {
    commissionFixe: CommissionFixe;
}

export function CommissionFixeDetailModal({ commissionFixe }: CommissionFixeDetailModalProps) {
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 ">
                        ...
                        />
                        Détails de la commission fixe <span className="font-bold text-red-500">REF-{commissionFixe.id}</span>
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="reference"
                            defaultValue={"REF-" + commissionFixe.id}
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="date"
                            defaultValue={commissionFixe.date}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="livreur"
                            defaultValue={commissionFixe.restaurant}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="coutCommande"
                            defaultValue={`${commissionFixe.localisation}`}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="commission"
                            defaultValue={`${commissionFixe.commission} FCFA`}

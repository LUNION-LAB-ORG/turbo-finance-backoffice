...
export const description = "Revenus hebdomadaire"
...
const chartConfig = {
    revenus: {
        label: "Revenus hebdomadaire",
        color: "hsl(142, 75.20%, 44.30%)", 
    },
} satisfies ChartConfig

export function LivraisonHebdomadaireChart() {
    return (
            <div>
                <div  className="pt-0">
                    ...
                    <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                        <span>Revenus hebdomadaire(millions)</span>
                        <span>Semaine</span>
                    </div>
                </div>
            </div>

...
import { Livraison } from "@/feature/revenus/types/revenus.types";
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 ">
                        ...
                        />
                        Détails de la livraison <span className="font-bold text-red-500">REF-{livraison.reference}</span>
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="reference"
                            defaultValue={"REF-" + livraison.reference}
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="coutLivraison"
                            defaultValue={`${livraison.coutLivraison} FCFA`}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="coutCommande"
                            defaultValue={`${livraison.coutCommande} FCFA`}
                            className="col-span-3"
                            readOnly
                        />
                    </div>

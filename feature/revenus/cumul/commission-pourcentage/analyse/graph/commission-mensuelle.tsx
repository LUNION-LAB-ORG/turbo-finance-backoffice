...
export const description = "Commission(pourcentage) mensuelle"
...
export function CommissionMensuellePourcentageChart() {
    return (
            <div>
                <div  className="pt-0">
                    ...
                    <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                        <span>Commission(pourcentage) mensuelle(millions)</span>
                        <span>Mois</span>
                    </div>
                </div>
            </div>

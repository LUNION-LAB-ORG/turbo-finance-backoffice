...
import { Investissement } from "@/feature/revenus/types/revenus.types";
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="date"
                            defaultValue={investissement.date_pret}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="investisseur"
                            defaultValue={investissement.investisseur}
                            className="col-span-3"
                            readOnly
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input
                            id="coutLivraison"
                            defaultValue={`${investissement.montant_pret} FCFA`}
